"""forward_24220 URL Configuration
...
admin.site.site_header = "forward"
admin.site.site_title = "forward Admin Portal"
admin.site.index_title = "forward Admin"

# swagger
api_info = openapi.Info(
    title="forward API",
    default_version="v1",
    description="API documentation for forward App",
)
